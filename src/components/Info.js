  ...
  return (
    <>
      <section
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-stretch sm:justify-center gap-6 sm:gap-10 mx-6 sm:mx-auto sm:max-w-3xl">
          ...
          <div className="bg-blue rounded-2xl px-8 py-8 sm:flex-1 sm:max-w-md flex flex-col justify-center text-center sm:text-left">
            <div className="text-sm sm:text-base font-semibold uppercase tracking-[0.2em] text-gray-light/70 mb-4">
              Mission
            </div>
